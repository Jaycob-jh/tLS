...
try
    ...
    if isempty(scoutsTxt)
        scoutsTxt = fullfile(fileparts(mfilename('fullpath')), 'yeo7_scouts.txt');
    end
    ...
    sOut = bst_process('CallProcess','process_psd', sFile, [], ...
        ...
        'win_overlap',50, ...
        'units','physical', ...
        'clusters', {'yeo2011_7networks_mni152_freesurferconformed1mm.nii_02', scoutNames}, ...
        'scoutfunc', 1, ...
        'win_std', 0, ...
